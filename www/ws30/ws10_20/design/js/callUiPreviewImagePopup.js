(function(){
    ...
    function lf_setInitData(UIOBK){
        ...
        //index.json 파일 경로 구성.
        var l_path = parent.PATH.join(parent.REMOTE.app.getAppPath(), "ws30", "ws10_20", "design", "image", C_FOLDER, "index.json" );
    ...
    function lf_AfterOpen(){
        ...
        for(var i=0, l=loApp.attr.image.T_IMG.length; i<l; i++){
            //이미지 파일 경로 구성.
            var l_path = parent.PATH.join(parent.REMOTE.app.getAppPath(), "ws30", "ws10_20", "design", "image", 
