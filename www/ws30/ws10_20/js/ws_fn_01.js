...
(function (window, $, oAPP) {
    ...
    const
     ...
     function _checkAppExists(oOptions = {}){

        return new Promise(function(resolve){        

            let sAppId = oOptions?.sAppId || "";

            // 입력값 유무 확인
            if (typeof sAppId !== "string" || sAppId === "") {            
                return resolve({ RETCD: "E", STCOD: "E001" }); 
            }

            // 입력값 공백 여부 체크
            var reg = /\s/;
            if (reg.test(sAppId)) {                
                return resolve({ RETCD: "E", STCOD: "E002" }); 
            }

            // 특수문자 존재 여부 체크
            var reg = /[^\w]/;
            if (reg.test(sAppId)) {                
                return resolve({ RETCD: "E", STCOD: "E003" }); 
            }
            ...
            function lf_result(RESULT) {
                ...
                let oAppInfo = RESULT.RETURN,
                    sCurrPage = parent.getCurrPage();

                if (RESULT.RETCD == 'E') {
                    return resolve({ RETCD: "E", STCOD: "E010" });
                }

                // USP App 일 경우 실행하지 않음.
                if (oAppInfo.APPTY === "U") {
                    return resolve({ RETCD: "E", STCOD: "E011" });
                }

                // Inactivate 상태일 경우
                if (oAppInfo.ACTST == "I") {
                    return resolve({ RETCD: "E", STCOD: "E012" });
                }

                return resolve({ RETCD: "S" }); 

            }

        });
        
    } // end of _launchAppInBrowser
    ...
    oAPP.fn.fnOnInitRendering = function () {
        ...
        if (oAPP.fn.fnRenderWs10Html) {
            ...
            try { APPCOMMON.setShortCut("WS10"); } catch (e) { console.error("setShortCut(WS10)", e); }
            return;
        }
    ...
    oAPP.fn.fnOnInitRendering_ui5 = function () {
        ...
        var oApp = new sap.m.NavContainer("WSAPP", {
            ...
            afterNavigate: function (oEvent) {
                ...
                let toId = oEvent.getParameter("toId");
                ...
                switch (toId) {
                    ...
                    case "WS10":
                        ...
                        let oAppNmInput = sap.ui.getCore().byId("AppNmInput");
                        if (oAppNmInput) {
                            oAppNmInput.focus();
                        }
                        ...
                        let oAppSrchDialog = sap.ui.getCore().byId("AppF4DialogWS10");
                        if(oAppSrchDialog && oAppSrchDialog.isOpen() === true && oAppSrchDialog.getVisible() === false){
                            oAppSrchDialog.oPopup.setModal(true);
                            oAppSrchDialog.setVisible(true);                            
                        }
        ...
        let WS10 = oAPP.fn.fnOnInitRenderingWS10(),
            ...
            */
            aWMENU20 = [
                ...
                },
                {
                    ...
                    text: parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "808") // Screen Recording
                },
                {
                    key: "WMENU20_05",
    ...
    ************************************************************************/
    ...
    oAPP.fn.fnGetHeaderToolbarContentWs10 = function () {
        ...
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.WMENU10);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.WMENU20);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.WMENU30);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.WMENU50);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.Test10);
        ...
        let oHeaderButtonTemplate = new sap.m.Button({
            text: "{text}",
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oHeaderButtonTemplate);
        ...
        return [
            ...
            new sap.m.HBox({
                items: {
                    ...
                    template: oHeaderButtonTemplate
                }
            }),
    ...
    oAPP.fn.fnGetSubHeaderToolbarContentWs10 = function () {
         ...
         * 생성 버튼
         */
        let oAppCreateBtn = new sap.m.Button("appCreateBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppCreateBtn);

        oAppCreateBtn.bindProperty("visible", jQuery.extend(true, {}, lo_bindPropForVisible));
        oAppCreateBtn.addStyleClass("u4aWs10AppCreateBtn");

        /**
         * 수정 버튼
         */
        let oAppChangeBtn = new sap.m.Button("appChangeBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppChangeBtn);

        oAppChangeBtn.bindProperty("visible", jQuery.extend(true, {}, lo_bindPropForVisible));
        oAppChangeBtn.addStyleClass("u4aWs10AppChangeBtn");

        /**
         * 삭제 버튼
         */
        let oAppDelBtn = new sap.m.Button("appDelBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppDelBtn);

        oAppDelBtn.bindProperty("visible", jQuery.extend(true, {}, lo_bindPropForVisible));
        oAppDelBtn.addStyleClass("u4aWs10AppDelBtn");

        /**
         * 복사 버튼
         */
        let oAppCopyBtn = new sap.m.Button("appCopyBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppCopyBtn);

        oAppCopyBtn.bindProperty("visible", jQuery.extend(true, {}, lo_bindPropForVisible));
        oAppCopyBtn.addStyleClass("u4aWs10AppCopyBtn");


        /**
         * 디스플레이 버튼
         */
        let oDisplayBtn = new sap.m.Button("displayBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oDisplayBtn);

        /**
         * 앱 실행 버튼
         */
        let oAppExecBtn = new sap.m.Button("appExecBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppExecBtn);


        /**
         * @since   2026-04-02 20:28:56
         * @version v3.6.0-4
         * @author  soccerhs
         * @description
         * 
         * 브라우저 실행 버튼 변경!
         * 
         * - 기존: 기본 브라우저 팝업에서 지정한 브라우저로 실행
         * - 변경: 브라우저 목록을 메뉴로 분류해서 즉시 원하는 브라우저로 실행 가능하게 변경함.
         */
        let oAppExecMenuBtn = new sap.m.MenuButton("appExecMenuBtn", {            
            buttonMode: "Split",
            ...
            defaultAction: function () {
                ...
                oAPP.events.ev_AppExec();

            },
            beforeMenuOpen: async function () {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppExecMenuBtn);

        let MENUITEM1 = new sap.m.MenuItem({
            key: "{NAME}",
            text: "{DESC}",
            enabled: "{ENABLED}",
            press: async function (oEvent) {
                ...
                const sCurrPage = parent.getCurrPage();
                ...
                let sBrowserType = oBindData.NAME;
                ...
                // 앱 정합성 체크
                let oLaunchBrowserResult = await _checkAppExists(oOptions);
                if(oLaunchBrowserResult.RETCD === "E"){

                    switch (oLaunchBrowserResult.STCOD) {
                        ...
                        case "E010":
                            ...
                            var sErrMsg = APPCOMMON.fnGetMsgClsText("/U4A/MSG_WS", "007", sAppId);
                        ...
                        case "E011":
                            ...
                            var sErrMsg = oAPP.common.fnGetMsgClsText("/U4A/MSG_WS", "189"); // USP apps are not supported.
                        ...
                        case "E012":
                            ...
                            var sErrMsg = parent.WSUTIL.getWsMsgClsTxt(sLangu, "ZMSG_WS_COMMON_001", "434");
                        ...
                        default:
                            ...
                            var aConsoleMsg = [
                                ...
                                `=> let oLaunchBrowserResult = await _launchAppInBrowser(oOptions)`,
                                `=> [RESULT]: ${JSON.stringify(oLaunchBrowserResult)}`,                                
                                `######################################\n`,
                            ];

                            console.error(aConsoleMsg.join("\r\n"));

                            // 314 알수 없는 오류가 발생하였습니다.
                            // 290 다시시도 하시거나, 문제가 지속될 경우 U4A 솔루션 팀에 문의 하세요.
                            var sErrMsg = parent.WSUTIL.getWsMsgClsTxt(sLangu, "ZMSG_WS_COMMON_001", "314");
                                sErrMsg += " " + parent.WSUTIL.getWsMsgClsTxt(sLangu, "ZMSG_WS_COMMON_001", "290");
                ...
                let sURL = oAPP.fn.fnGetAppUrl(sAppId);

                let oBrowserOptions = {
                    BROWSER_TYPE: oBindData.NAME,
                    INSPATH: oBindData.INSPATH,
                    APP_MODE: false,
                    URL: sURL
                };

                let oAppOpenResult = await oAPP.fn.fnOpenAppInBrowser(oBrowserOptions);
                if(oAppOpenResult.RETCD === "E"){

                    switch (oAppOpenResult.STCOD) {
                        case "E001":

                            // 설치된 브라우저 정보를 찾을 수 없습니다.
                            var sErrMsg = APPCOMMON.fnGetMsgClsText("/U4A/MSG_WS", "333");
                        ...
                        default:
                            ...
                            var aConsoleMsg = [
                                ...
                                `=> ${parent.WSUTIL.getStackTraceInfo()}`,
                                `=> let oAppOpenResult = await oAPP.fn.fnOpenAppInBrowser(oBrowserOptions)`,
                                `=> [RESULT]: ${JSON.stringify(oAppOpenResult)}`,                                
                                `######################################\n`,
                            ];
        ...
        MENUITEM1.bindProperty("visible", {
            parts: [
                { path: "NAME" }
            ],
        ...
        MENUITEM1.bindProperty("enabled", {
            parts: [
                { path: "NAME" },
                { path: "ENABLED" },
            ],
             ...
             * @param {boolean} bEnabled 활성화 여부
             */
            formatter: function(sName, bEnabled) {

                // 1. 기본 필수 조건 체크 (이름이 없거나, 명시적 비활성 상태면 광탈)
                if (!sName || bEnabled === false) {
                    return false;
                }
                
                // 2. WS10번 페이지에서는 개발모드 브라우저 메뉴는 비활성화 시킨다.
                if (sName === "DEV_BROWSER") {
                    return false;
                }
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(MENUITEM1);

        MENUITEM1.bindProperty("icon", "NAME", function (values) {
            ...
            switch (values) {
                ...
                case "DEV_BROWSER":
                    return "sap-icon://u4a-fw-brands/DEV";
        ...
        let MENU1 = new sap.m.Menu("ws10_appExecMenu", {
            items: {
                path: "/DEFBR",
                template: MENUITEM1
            }
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(MENU1);

        oAppExecMenuBtn.setMenu(MENU1);


        /**
         * 예제 샘플 버튼
         */
        let oExamBtn = new sap.m.Button("examBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oExamBtn);

        /**
         * 멀티 미리보기 버튼
         */
        let oMultiPrevBtn = new sap.m.Button("multiPrevBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMultiPrevBtn);


        /**
         * 새창 실행 버튼
         */
        let oNewWindowBtn = new sap.m.Button("newWindowBtn", {
            text: APPCOMMON.fnGetMsgClsText("/U4A/CL_WS_COMMON", "A09"), // New Window
            icon: "sap-icon://create",
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oNewWindowBtn);
    ...
    oAPP.fn.fnGetPageContentWs10 = function () {
        ...
        let oAppNmInput = new sap.m.SearchField("AppNmInput", {
            value: "{/WS10/APPID}",
         ...
         * 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
         */
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAppNmInput);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oHtml);

        let oPage = new sap.m.Page("ws10_contPage", {
            showHeader: false,
            enableScrolling: false,
            content: [
                oHtml,
    ...
    function _getWs10ContentHtml() {
        ...
        // let sHtmlPath = PATH.join(APPPATH, "ws30", "ws10_20", "ws10_content", "intro.html");

        // let sIframe = `<iframe src=${sHtmlPath} style="width:100%;height:100%;border:0px;"></iframe>`;
    ...
    oAPP.fn.fnGetHeaderToolbarContentWs20 = function () {
        ...
        let sBindRoot = "/WMENU/WS20";

        let oBackBtn = new sap.m.Button("backBtn", {
         ...
         * 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
         */
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oBackBtn);

        let oAppIdTxt = new sap.m.Title({
            text: "{/WS20/APP/APPID}"
        }), // APPID
        ...
        let oFindBtn = new sap.m.Button("ws20_findBtn", {
         ...
         * 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
         */
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oFindBtn);

        let oNewWin = new sap.m.Button("ws20_newWinBtn", {
            icon: "sap-icon://create",
         ...
         * 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
         */
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oNewWin);
    ...
    oAPP.fn.fnOnInitRenderingWS20 = function () {
        ...
        let sFmsgBindRootPath = "/FMSG/WS20";

        /*****************************************************************************
         * 20번 상단 헤더 -- START
         *****************************************************************************/

        let aHeaderToolbarContents = oAPP.fn.fnGetHeaderToolbarContentWs20(),
         ...
         * 20번 상단 헤더 -- END
         *****************************************************************************/
        let oSideNav = new sap.tnt.SideNavigation({
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oSideNav);

        // 이거를 차장님께 전달할 Page 임.
        let oMainPage = oAPP.fn.fnOnInitRenderingWS20Main(),
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.WMENU40);
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMenuUI.Test20);
        ...
        oHeaderButtonTemplate.bindProperty("visible", {
            parts: [
                "key",
                "/WS20/APP/S_APP_VMS"
            ],
    ...
    oAPP.fn.fnGetSubHeaderToolbarContentWs20 = function () {
        ...
        let sVisiBindPath = "/WS20/APP/IS_EDIT";

        let oSyntaxCheckBtn = new sap.m.Button("syntaxCheckBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oSyntaxCheckBtn);
        ...
        let oDisplayModeBtn = new sap.m.Button("displayModeBtn", {
            icon: "sap-icon://display",
            tooltip: sDispChgTxt,
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oDisplayModeBtn);
        ...
        let oChangeModeBtn = new sap.m.Button("changeModeBtn", {
            icon: "sap-icon://edit",
            tooltip: sDispChgTxt,
            press: oAPP.events.ev_pressDisplayModeBtn
        });
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oChangeModeBtn);
        ...
        let oActivateBtn = new sap.m.Button("activateBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oActivateBtn);
        ...
        let oSaveBtn = new sap.m.Button("saveBtn", {
            icon: "sap-icon://save",
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oSaveBtn);
        ...
        let oMimeBtn = new sap.m.Button("mimeBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMimeBtn);

        let oControllerBtn = new sap.m.Button("controllerBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oControllerBtn);

        /**
         * 앱 실행 버튼
         */
        let oAppExecBtn = new sap.m.Button("ws20_appExecBtn", {
            icon: "sap-icon://internet-browser",
            text: APPCOMMON.fnGetMsgClsText("/U4A/CL_WS_COMMON", "A06"), // Application Execution                
         ...
         * - 변경: 브라우저 목록을 메뉴로 분류해서 즉시 원하는 브라우저로 실행 가능하게 변경함.
         */
        let oAppExecMenuBtn = new sap.m.MenuButton("ws20_appExecMenuBtn", {            
            buttonMode: "Split",
            useDefaultActionOnly: true,
            icon: "sap-icon://internet-browser",
            text: APPCOMMON.fnGetMsgClsText("/U4A/CL_WS_COMMON", "A06"), // Application Execution    
            ...
            defaultAction: function () {
                ...
                oAPP.events.ev_pressAppExecBtn();
        ...
        oAppExecMenuBtn.bindProperty("visible", {
            parts: [
                "/WS20/APP/S_APP_VMS",
            ],
            formatter: function (S_APP_VMS) {
        ...
        let MENUITEM1 = new sap.m.MenuItem({
            ...
            press: async function (oEvent) {
                ...
                const sCurrPage = parent.getCurrPage();
                const ACTST = oAppInfo.ACTST;
                // const APPID = oAppInfo.APPID;
        ...
        MENUITEM1.bindProperty("enabled", {
            ...
            formatter: function(sName, bEnabled) {
                ...
                //#region 개발 브라우저 배포 금지 로직
                //#endregion
                // 2. 개발자 도구 특수 제어 (패키징된 운영 환경이면 차단)
                if (sName === "DEV_BROWSER" && parent.APP.isPackaged) {
                    return false;
                }
        ...
        let MENU1 = new sap.m.Menu("ws20_appExecMenu", {
            items: {
                path: "/DEFBR",
                template: MENUITEM1
            }
        ...
        let oMobileBtn = new sap.m.Button("ws20_multiPrevBtn", {
            icon: "sap-icon://desktop-mobile",
            text: APPCOMMON.fnGetMsgClsText("/U4A/CL_WS_COMMON", "A08"), // App Multi Preview                
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oMobileBtn);
        ...
        let oIconListBtn = new sap.m.Button("iconListBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oIconListBtn);
        ...
        let oIconCollection = new sap.m.MenuButton({
            icon: "sap-icon://u4a-fw-regular/Face Grin Wide",
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oIconCollection);

        let oAddEventBtn = new sap.m.Button("addEventBtn", {
            icon: "sap-icon://touch",
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oAddEventBtn);
        ...
        let oRuntimeBtn = new sap.m.Button("runtimeBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oRuntimeBtn);
        ...
        let oBindPopupBtn = new sap.m.Button("bindPopupBtn", {
        ...
        // 해당 실행 스크립트 파일경로 및 소스 라인 정보 저장
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oBindPopupBtn);
