...
(function (window, $, oAPP) {
  ...
  function lf_apply() {
    ...
    try { oAPP.fn.fnWs20AttrChange(oCtx.attr, "INPUT", false, false, true); }   //[BR54] 원본은 이 자리에서 attrChangeProc 직접 호출 = 전용 예외처리 갈래 없음(원본 uiAttributeArea.js:2953).
    catch (e) { console.error("[WS20][DumpWrite] attr change handle error:", e && e.message); }
