...
window.require([
     ...
     ***********************************************************************/  
        ...
        // [정리 2026-07-13] 개발용 실험/디버그 코드 제거 — 테스트 대문자 HTML 포맷터 등록,
        //   init 시 formatDocument 자동실행, setModelLanguage 강제 javascript(파일언어 무시 원인),
        //   샘플 코드액션/hover, 디버그 위젯(outputWidget) 일괄 삭제. 언어는 파일 확장자대로 유지한다.
