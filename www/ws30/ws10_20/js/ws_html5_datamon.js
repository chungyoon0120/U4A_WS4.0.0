...
(function (window, $, oAPP) {
     ...
     */
    function _snap(v, iDepth, aChain) {
        ...
        if (_isUiPart(v)) {
            ...
            for (var i = 0; i < aKeys.length; i++) {
                try {
                    ...
                    vOut[aKeys[i]] = _snap(vChild, iDepth + 1, aChain);
                } catch (e) {
    ...
    function _snapUiPart(v, iDepth, aChain) {
        ...
        for (var i = 0; i < C_UI_KEEP.length; i++) {
            ...
            oOut[sK] = _snap(vVal, iDepth + 1, aChain);
        }
    ...
    function _takeSnapshot() {
        ...
        for (var sName in oTargets) {
            oShot[sName] = _snap(oTargets[sName], 0, []);
        }
