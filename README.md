...
> 최종 산출: **2026-06-26** · 현행화: **2026-06-26** (재조사 6개 완료 반영) · 상세: **[변환 잔여 산출 보고서](UI5_HTML5_변환잔여_산출보고서.md)**

WS10 / WS20 / WS30 전체 단위기능을 전수 조사한 잔여 작업 현황. 잔여는 **두 축**으로 나뉜다.

| 축 | 의미 | 잔여 | 변동 |
|---|---|:---:|:---:|
| **① UI5 팝업 변환** | 별도 UI5 코드 → HTML5 재작성 | **17** | ▼1 |
| **② 코어 미구현** | 원본 로직 → 현행 HTML5 코드에 이식 | **15** | ▼5 |
| **합계** | | **≈ 32** | ▼6 |

> ✅ **최근 완료 (6)**: WS30 K4 Delete · K7 Rename · K8 Up · K9 Down · K10 Move Position · 팝업 fnWebSecurity.
...
| **WS30 USP** | 2 | 트리 우클릭 K5 Download · K6 Test Service *(K4·K7·K8·K9·K10 완료)* |
...
1. **WS30 트리 K5 Download · K6 Test Service** — K4~K10 중 마지막 2개, 동일 패턴 이식
